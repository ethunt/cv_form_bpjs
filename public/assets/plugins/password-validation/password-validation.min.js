...
myInput.onkeyup = function() {
  ...
  var specialCaseLetters = /[~`!@#$%\^&*()\-_=+[\]{};:\x27.,\x22\\|/?><]/g;
...
confirmation.onkeyup = function () {
  ...
  if (document.getElementById("password_confirmation").value == document.getElementById("password").value) {
    document.getElementById("confirmpwd").classList.remove("unconfirmed_pass");
    document.getElementById("confirmpwd").classList.add("confirmed_pass");
  } else {
    document.getElementById("confirmpwd").classList.remove("confirmed_pass"); 
    document.getElementById("confirmpwd").classList.add("unconfirmed_pass");
  }
}